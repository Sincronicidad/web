    ...
    return (
        <div className="checkingEmail">
            <div className="checking_left">
                ...
                <h2 className="checking_h2">
                    ¿No recibiste un correo electrónico?
                </h2>

                <p className="checking_p">
                    Si no lo recibiste dentro de las 72 horas por parte de
                    nosotros, algunos incovenientes podrían haber pasado:
                </p>

                <ul className="checking_bullets">
                    <li>El e-mail está en tu carpeta Spam</li>
                    <li>
                        La dirección de correo electrónico que registraste tiene
                        algún error o letra.
                    </li>
                    <li>
                        Accidentalmente registraste algúna otra dirección de
                        correo electrónico.
                    </li>
                    <li>
                        Nosotros no podemos enviarte el e-mail a esta dirección.{" "}
                    </li>
                </ul>
