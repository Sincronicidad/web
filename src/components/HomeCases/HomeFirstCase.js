                        ...
                        <form onSubmit={stepperForm}>
                            ...
                            <div className="form-control">
                                <label htmlFor="country">
                                    Zona geográfica que representa (Ciudad,
                                    Estado y País)
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="form-control">
                                ...
                                <textarea
                                    ...
                                    cols="30"
                                    rows="10"
                                    placeholder="Describe brevemente el tipo de caso y mencione los intereses que desea sean supervizados."
                                ></textarea>
                            </div>
            ...
            case 2:
                return (
                    <div className="stepperFileUpload">
                        <h4>
                            Link del conjunto de datos (preferible si es un
                            archivo mayor de 1gb)
                        </h4>
                        <input
                            type="url"
                            value={linkForFile}
                            onChange={(e) => setLinkForFile(e.target.value)}
                        />
                ...
                return (
                    <div className="uploadCase">
                        ...
                        <div className="uploadCase__right">
                            ...
                            <p>
                                Tipo de enfoque: <span> {textArea}</span>{" "}
                            </p>
                            <p>
            ...
            <div className={`${classes1.root} stepper`}>
                ...
                {activeStep === steps.length && (
                    <Paper
                        square
                        elevation={0}
                        className={classes1.resetContainer}
                    >
                        <Typography>
