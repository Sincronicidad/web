  ...
  return (
    <div className="evaluation">
      <div className="evaluation_left">
        ...
        <h2 className="evaluation_h2">Un administrador evaluará tu perfil</h2>

        <p className="evaluation_p">
          Podría recibir un correo electrónico en las próximas horas a su correo
          electrónico juanhernandezg@gmail.com con un enlace para activar tu
          cuenta.
          <br />
          <br />
          ¿Sabes acerca de las funcionalidades de la plataforma?
        </p>
        <Button className="evaluation-btn" onClick={()=> navigate('/checkingEmail')} variant="contained" component="span">
          Conoce más
        </Button>
      </div>
